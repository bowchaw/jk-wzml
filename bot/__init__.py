...
if len(DOWNLOAD_DIR) == 0:
    DOWNLOAD_DIR = '/usr/src/app/warish/'
...
try:
    ...
    if len(USER_SESSION_STRING) != 0:
        premium_session = Client('Jitendra-Premium', api_id=TELEGRAM_API, api_hash=TELEGRAM_HASH, session_string=USER_SESSION_STRING, parse_mode=enums.ParseMode.HTML, no_updates=True)
...
if len(START_BTN1_NAME) == 0 or len(START_BTN1_URL) == 0:
    ...
    START_BTN1_URL = 'https://t.me/iamjitendrakumar'

START_BTN2_NAME = environ.get('START_BTN2_NAME', '')
START_BTN2_URL = environ.get('START_BTN2_URL', '')
if len(START_BTN2_NAME) == 0 or len(START_BTN2_URL) == 0:
    START_BTN2_NAME = 'Discussion Group'
    START_BTN2_URL = 'https://t.me/disneyke14'
...
if len(AUTHOR_URL) == 0:
    AUTHOR_URL = 'https://t.me/iamjitendrakumar'
...
if len(GD_INFO) == 0:
    GD_INFO = 'Uploaded by Jitendra Mirror Bot'

CREDIT_NAME = environ.get('CREDIT_NAME', '')
if len(CREDIT_NAME) == 0:
    CREDIT_NAME = 'Jitendra'
...
if len(UPSTREAM_REPO) == 0:
   UPSTREAM_REPO = 'https://github.com/bowchaw/jk-wzml'
