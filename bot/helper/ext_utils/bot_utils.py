    ...
    with download_dict_lock:
        ...
        for index, download in enumerate(list(download_dict.values())[COUNT:], start=1):
            if config_dict['SAFE_MODE']:
                msg += f"<b>{download.status()}: <a href='https://t.me/iamjitendrakumar'>Jitendra</a> Safe Mode</b>"
            else:
            ...
            if download.status() not in [MirrorStatus.STATUS_SEEDING, MirrorStatus.STATUS_SPLITTING, MirrorStatus.STATUS_CONVERTING, MirrorStatus.STATUS_QUEUEDL, MirrorStatus.STATUS_QUEUEUP]:
                if config_dict['EMOJI_THEME']:
                    msg += f"\n<b><a href='https://t.me/iamjitendrakumar'>{get_progress_bar_string(download.progress())}</a></b> {download.progress()}"
        ...
        if config_dict['EMOJI_THEME']:
            ...
            bmsg += f"<b>‎‎<a href='https://t.me/iamjitendrakumar'>Powered By Jitendra Kumar</a></b>\n"
