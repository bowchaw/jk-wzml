...
class _BotCommands:
    def __init__(self):
        self.RCommand = getCommand(f'R_COMMAND', f'r{CMD_SUFFIX}')
        self.DlCommand = getCommand(f'DL_COMMAND', f'dl{CMD_SUFFIX}')
        self.UpCommand = getCommand(f'UP_COMMAND', f'up{CMD_SUFFIX}')
        self.LhCommand = getCommand(f'LH_COMMAND', f'h{CMD_SUFFIX}')
